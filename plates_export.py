...
import pandas as pd
# 1. Ouvrir la gdb: 
data = ogr.Open(r"C:\PANALESIS\Vers0_christian\Plates_psAbs")
...
input_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs"
output_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs_output006.gpkg"
...
input_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs"
output_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs_output.gpkg"
...
#Definir input et output path : 
input_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs"
output_directory = r"C:\PANALESIS\Vers0_christian\Plates_psAbs_output006.geojson"
...
# Export GeoJSON
gdf_all.to_file("output_Plates_psAbs.geojson", driver="GeoJSON")
print("export done")