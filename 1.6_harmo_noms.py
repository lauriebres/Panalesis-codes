...
print(len(values), "nombre de noms différents :") # pour obtenir le nombre de noms différents trouvés pour tous les âges

for v in sorted(values):
    print(v)
    
    
# Faire la même chose pour le fichier des lignes :
...
# Same pour le fichier des lignes :
...
print("Noms présents uniquement dans gpkg R_psAbs :")
...
# Harmonisation au moyen d'un mapping:
...
plate_name_mappings_R_psAbs = {'ALTAI_QUIEUE' : 'ALTAI_QUEUE',
                               ...
                               'MADAG' : 'MAD', 
                               'NAZ' : 'NAZCA',
                               'PHRYGIAN_2' : 'PHRYGIAN_N',
                               'SANAND' : 'SANANDAJ',
                               'TONGA_KER' : 'TONG_KER',
                               'YUCON' : 'YUKON'}

# Export pour le gpkg des plaques :
...
# Export pour le gpkg des lignes :
