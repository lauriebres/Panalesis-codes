...
# 1. Ouvrir la gdb: 
data = ogr.Open(r"C:\PANALESIS\v0_christian\COB_psAbs")
...
input_directory = r"C:\PANALESIS\v0_christian\COB_psAbs"
output_directory = r"C:\PANALESIS\v0_christian\COB_psAbs_output006.gpkg"
...
input_directory = r"C:\PANALESIS\v0_christian\COB_psAbs"
output_directory = r"C:\PANALESIS\v0_christian\COB_psAbs_output.gpkg"
...
#Definir input et output path : 
input_directory = r"C:\PANALESIS\v0_christian\COB_psAbs"
output_directory = r"C:\PANALESIS\v0_christian\COB_psAbs_output006.geojson"

#Selectionner la couche 006
inputl006 = ogr.Open(input_directory)
layer006_input = inputl006.GetLayer(1)

#Spécifier qu'on veut GeoJSON et créer un file pour stocker la couche.gpkg
...
input_directory = r"C:\PANALESIS\Vers0_christian\COB_psAbs"
output_directory = r"C:\PANALESIS\v0_christian\COB_psAbs_output006.geojson"
input = ogr.Open(input_directory)
driver = ogr.GetDriverByName("GEOJSON")
...
#Export GeoJSON
gdf_all.to_file("output_COB_psAbs.geojson", driver="GeoJSON")
print("export done")