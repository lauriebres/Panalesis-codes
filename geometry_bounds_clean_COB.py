...
output_directory = r"C:\PANALESIS\outputs\COB_psAbs_output_bounds_clean.gpkg"
...
path = r"C:\PANALESIS\outputs\COB_psAbs_output_bounds_clean.gpkg"
layers = fiona.listlayers(path)
